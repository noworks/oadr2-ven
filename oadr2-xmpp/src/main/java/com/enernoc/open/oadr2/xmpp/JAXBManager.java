...
/**
 * Convenience class for using JAXB with OpenADR 2.0a profile generated classes.
 * This is basically initializes the {@link JAXBContext} with the right context
 * path (see {@link #DEFAULT_JAXB_CONTEXT_PATH}) and provides convenience
 * methods to build a {@link Marshaller} instance.
 * 
 * @author tnichols
 */
