...
/**
 * XML Namespace and prefix definitions for all URIs used in OpenADR profile
 * 2.0a. Note that payloads received are not guaranteed to use the prefixes
 * defined here, you <em>must</em> use a namespace-aware XML parser. However
 * these prefixes are handy if you want sent payloads to use the standard
 * prefixes.
 * 
 * @author tnichols
 */
public enum XMLNS {
	...
	XSI("http://www.w3.org/2001/XMLSchema-instance", "xsi"), OADR2("http://openadr.org/oadr-2.0a/2012/07", "oadr2"), EI(
			...
			"ei"), PYLD("http://docs.oasis-open.org/ns/energyinterop/201110/payloads", "pyld"), EMIX(
					"http://docs.oasis-open.org/ns/emix/2011/06", "emix"), ICAL("urn:ietf:params:xml:ns:icalendar-2.0",
							"ical"), STRM("urn:ietf:params:xml:ns:icalendar-2.0:stream", "strm");
