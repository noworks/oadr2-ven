...
/**
 * This is an implementation of the Smack {@link IQProvider} to provide
 * automatic de-serialization of OpenADR payloads in XMPP. IQs that contain an
 * OpenADR payload will automatically be parsed as {@link OADR2IQ} instances.
 * 
 * @author tnichols
 */
public class XMPPExtensionProvider implements PacketExtensionProvider, IQProvider {
	...
	public XMPPExtensionProvider(JAXBManager jaxb) {
		...
		// System.out.println("++++++++++++++++++++ LOADED OADR Packet Extension
		// Provider");
	}
